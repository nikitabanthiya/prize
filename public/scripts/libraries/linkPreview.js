...
(function ($) {
    $.fn.linkPreview = function (options) {
        ...
        $('#post').click(function () {     //$('#postPreviewButton_' + selector).click(function () {
            ...
            if (((trim(text) !== "") || (trim(text) === "" && trim(hrefUrl) !== "")) && (allowPosting === true && isCrawling === false)) {
                $.get('php/highlightUrls.php', {
                    ...
                    content = ''; //'<div class="previewPosted col-lg-12 col-md-12 full">' + '<div class="previewTextPosted">' + urls.urls + '</div>' + videoIframe + '<div class="previewImagesPosted">' + '<div class="previewImagePosted">' + leftSideContent + '</div>' + '</div>' + '<div class="previewContentPosted">' + '<div class="previewTitlePosted" id="' + pTP + '" style="width: ' + contentWidth + 'px" ><a href="' + hrefUrl + '" target="_blank">' + title + '</a></div>' + '<div class="previewUrlPosted">' + fancyUrl + '</div>' + '<div class="previewDescriptionPosted" id="' + pDP + '" style="width: ' + contentWidth + 'px" >' + urls.description + '</div>' + '</div>' + '<div style="clear: both"></div>' + '</div>';
                    ...
                    */
                    ...
                    angular.element(document.getElementById('post')).scope().post(param);
